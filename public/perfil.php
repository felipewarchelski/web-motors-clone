...
<body>
    <section class="header">
        ...
        <a class="user" href="#">
            <div class="circle"> <?php //código pra puxar a primeira letra do usuário 
                                    ?> </div>
        </a>
    </section>
    <section class="main">
        <div class="navbar">
            <div class="navbar-header">
                ...
                <div class="user-data">
                    <!-- lógica em php pra puxar nome e email -->
                    <h3>nome</h3>
                    <h4>email</h3>
                </div>
            </div>
            ...
            <div class="forms">
                ...
                <div class="form2">
                    ...
                    <form>
                        ...
                        <div class="mb-3">
                            <input type="fone" class="form-control" placeholder="Telefone" required>
                        </div>
                    </form>
                </div>
            </div>
        </div>
        <button type="button" class="btn btn-danger botao">Salvar Alterações</button>
    </section>
</body>
