...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['salvar_alteracoes'])) {
    ...
    $result_email_check = mysqli_query($con, $check_email_exists);
        ...
        <div class="navbar">
            ...
            <div class="nav-content">
                ...
                <a href="#">
                    ...
                    Ajuda</a>
                <a href="../app/includes/logout.php" onclick="confirmLogout(event)">
                    <svg width="25" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <form method="POST">
                ...
                <div class="forms">
                    <div class="form1">
                        ...
                        <div class="mb-3">
                            <?php echo  '<input type="email" name="email" class="form-control" placeholder="Email" required value="' . $info['email'] . '">'; ?>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="form2">
                        ...
                        <div class="g-3 row">
                            <div class="col">
                                <?php echo  '<input type="text" name="uf" maxlength="2" class="form-control" placeholder="Estado" value="'. $info['uf'] . '" aria-label="Estado">';?>
                            </div>
                            <div class="col">
